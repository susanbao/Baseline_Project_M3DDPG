...
def get_command(scenario_index = 8, exp_index = 0, cuda_index = 1, alg = "m3", good_policy = "mmmddpg", adv_policy = "mmmddpg"):
    ...
    opt1['good-policy'] = good_policy
    opt1['bad-policy'] = adv_policy
...
run(scenario_index = 3, cuda_index = 0)
run(scenario_index = 4, cuda_index = 1)
#run(scenario_index = 5)
#run(scenario_index = 6)
run(scenario_index = 7, cuda_index = 1)
